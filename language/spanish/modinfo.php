...
define("_MI_SSECTION_DISSBCATDSCDSC", "Elija 'Sí' para mostrar la descripción de las subcategorías en el índice y la página de la categoría.");
define("_MI_SSECTION_DISTYPE", "[OPCIONES DE FORMATO] ¿Tipo de visualización para los artículos:");
define("_MI_SSECTION_DISTYPEDSC", "Si la 'Vista de sumario' está seleccionada, sólo el título, la fecha y las lecturas de cada artículo serán mostrados en la categoría elegida. Si la 'Vista Completa' es la seleccionada, cada artículo será plenamente mostrado en la categoría elegida.");
...
define("_MI_SSECTION_WELCOMEDSC", "Si esta opción está marcada como 'Sí', la página de inicio del módulo mostrará el título 'Bienvenido a ...', seguida del mensaje de bienvenida. Si esta opción está marcada como 'No' ninguna de estas líneas será mostrada.");
...
define("_MI_SSECTION_DISPBREAD", "Mostrar los 'breadcrumbs'");
define("_MI_SSECTION_DISPBREADDSC", "La navegación 'Breadcrumb' muestra el contexto de la página actual dentro de ĺa estructura del sitio.");
