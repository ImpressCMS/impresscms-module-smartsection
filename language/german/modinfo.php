...
define("_MI_SSECTION_ADMINHITSDSC", "Erlaube Admin Z�hler für Aufrufe?");
...
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY", "Neuer Artikel ver�ffentlicht");
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_CAP", "Benachrichtige mich, wenn ein neuer Artikel in der aktuellen Kategorie ver�ffentlicht wurde.");   
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_DSC", "Informiere mich, wenn ein neuer Artikel in der aktuellen Kategorie ver�ffentlicht wurde.");      
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Artikel in der Kategorie ver�ffentlicht"); 
...
define("_MI_SSECTION_CATLIST_IMG_W", "Kategorieliste Bildgr��e"); 
define("_MI_SSECTION_CATLIST_IMG_WDSC", "Spezifizieren Sie die Bildgr��e der Kategorie für die Auflistung der Kategorien."); 
define("_MI_SSECTION_CATMAINIMG_W", "Kategorie Hauptbildgr��e"); 
define("_MI_SSECTION_CATMAINIMG_WDSC", "Spezifizieren Sie die Bildgr��e für das Hauptbild der Kategorie."); 
...
define("_MI_SSECTION_CLONEDSC", "W�hle 'Ja', um Usern mit entsprechender Berechtigung das Duplizieren von Artikeln zu erlauben.");
...
define("_MI_SSECTION_COMMENTSDSC", "Wenn die Option auf 'Yes' setzen, werden Kommentare nur für die Artikel, die diese Checkbox markiert haben, angezeigt. <br /><br />W�hle 'Nein', um Kommentare auf globaler Ebene zu managen (sehen Sie auch unter dem Tag 'Komentar Eigenschaften'.");
...
define("_MI_SSECTION_DISCOM", "Kommentarz�hler anzeigen?");
define("_MI_SSECTION_DISCOMDSC", "W�hle 'Ja', um den Kommentarz�hler in jedem individuellen Artikel anzuzeigen");
define("_MI_SSECTION_DISDATECOL", "Zeige die 'Ver�ffentlicht am' Spalte?");
define("_MI_SSECTION_DISDATECOLDSC", "Wenn 'Zusammenfassung' ausgew�hlt wurde, w�hle 'Ja' um das 'Ver�ffentlicht am' Datum in einer Artikelspalte auf der Haupt- und Kategorieseite anzuzeigen.");
define("_MI_SSECTION_DCS", "Kategoriezusammenfassung anzeigen?");
define("_MI_SSECTION_DCS_DSC", "W�hle 'Nein', um die Kategoriezusammenfassung auf einer Kategorieseite, die keine Unterkategorien hat, nicht anzuzeigen.");
define("_MI_SSECTION_DISPLAY_CATEGORY", "Kategorienamen anzeigen?");
define("_MI_SSECTION_DISPLAY_CATEGORY_DSC", "W�hle 'Ja', um den Link zur Kategorie in jedem individuellen Artikel anzuzeigen");
...
define("_MI_SSECTION_DISSBCATDSCDSC", "W�hle 'Ja', die Beschreibungen von Unterkategorien auf der Haupt- und Kategorieseite anzuzeigen.");
define("_MI_SSECTION_DISTYPE", "Artikel-Anzeigetyp:");
define("_MI_SSECTION_DISTYPEDSC", "Wenn 'Zeige Zusammenfassung' ausgew�hlt ist, wird nur der Titel, das Datum und die Aufrufe von jedem Artikel in der ausgew�hlten Kategorie angezeigt. Wenn 'Vollansicht' ausgew�hlt ist, wird jeder Artikel der ausgew�hlten Kategorie vollst�ndig angezeigt.");
define("_MI_SSECTION_FILEUPLOADDIR", "Verzeichnis zum Hochladen von angeh�ngten Dateien:");
define("_MI_SSECTION_FILEUPLOADDIRDSC", "Verzeichnis, in welches Anh�nge zum Artikel importiert werden können. Keine Schr�gstriche verwenden.");
...
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY", "Neuer Artikel ver�ffentlicht");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_CAP", "Benachrichte mich, wenn ein neuer Artikel ver�ffentlicht wurde.");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_DSC", "Mitteilung empfangen, wenn ein neuer Artikel ver�ffentlicht wurde.");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Artikel ver�ffentlicht");
...
define("_MI_SSECTION_HELP_PATH_CUSTOM_DSC", "Wenn Sie in den vorhergehenden Optionen 'Kundenspezifischer Pfad' gew�hlt haben, spezifizieren Sie bitte die URL für SmartSection's Hilfedatei in diesem Format: http://www.yoursite.com/doc");
define("_MI_SSECTION_HELP_PATH_SELECT", "Pfad für SmartSection's Hilfedatei");
define("_MI_SSECTION_HELP_PATH_SELECT_DSC", "W�hlen Sie, von wo aus Sie die SmartSection's Hilfedatei bearbeiten wollen. Wenn Sie das 'SmartSection's Hilfe Packet' downlaoden und auf 'modules/smartsection/doc/' hochladen, können Sie auswählen 'Innerhalb des Moduls'. Alternativ können Sie die Modul-Hilfe-Datei direkt auf docs.xoops.org bearbeiten und auswählen. Sie können auch 'Kundenspezifischer Pfad' wählen und den Pfad selbst in der n�chsten Konfigurationsoption 'Kundenspezifischer Pfad für SmartSection's Hilfedatei' bearbeiten");
define("_MI_SSECTION_HITSCOL", "Zeige für Spalte für 'Aufrufe'?");
define("_MI_SSECTION_HITSCOLDSC", "Wenn 'Zusammenfassung' ausgew�hlt ist, w�hle 'Ja', um die 'Aufrufe' Spalte in der Artikeltabelle auf der Haupt- und Kategorieseite anzuzeigen.");
...
define("_MI_SSECTION_ITEM_TYPEDSC", "W�hle Art des Artikels, die dieses Modul managen soll.");
...
define("_MI_SSECTION_LASTITEMDSC", "W�hle 'Ja', um den letzten Artikel in jeder Kategorie auf der Haupt- und Kategorieseite anzuzeigen.");
define("_MI_SSECTION_LASTITEMS", "Zeige Liste der neuesten ver�ffentlichten Artikel?");
define("_MI_SSECTION_LASTITEMSDSC", "W�hle 'Ja', um eine Liste  der Unterseiten auf der ersten Seite des Moduls anzuzeigen");
define("_MI_SSECTION_LASTITSIZE", "Letzte Gr��e des Artikels:");
define("_MI_SSECTION_LASTITSIZEDSC", "Setze die maximale Gr��e des Titels in der letzten Artikelspalte.");
...
define("_MI_SSECTION_MAX_HEIGHT", "Maximale H�he der hochgeladenen Bilder");
define("_MI_SSECTION_MAX_HEIGHTDSC", "Maximale H�he der Bilddatei, die hochgeladen werden kann.");
define("_MI_SSECTION_MAX_SIZE", "Maximale Dateigr��e");
define("_MI_SSECTION_MAX_SIZEDSC", "Maximale Gr��e (in Bytes) der Datei, die hochgeladen werden kann.");
...
define("_MI_SSECTION_ORDERBYDSC", "W�hle die Auftragsart des Artikels aus.");
...
define("_MI_SSECTION_OTHERITEMSDSC", "W�hlen Sie aus, wie die anderen Artikel der Kategorie auf der Artikelseite dargestellt werden sollen.");
...
define("_MI_SSECTION_SHOW_SUBCATS_DSC", "W�hle aus, wenn die Unterkategorien in der Kategorienauflistung auf der Haupt- und Kategorieseite angezeigt werden sollen");
...
define("_MI_SSECTION_SUB_SMNAME2", "Popul�re Artikel");
...
define("_MI_SSECTION_TITLE_SIZE", "Titel Gr��e:");
define("_MI_SSECTION_TITLE_SIZEDSC", "Setze maximale Gr��e des Titels des einzelnen Artikel.");
...
define("_MI_SSECTION_WHOWHENDSC", "W�hle 'Ja', um den Autor und Datuminformationen in dem individuellen Artikel anzuzeigen");
define("_MI_SSECTION_WYSIWYG", "Editor Typ");
define("_MI_SSECTION_WYSIWYGDSC", "Welchen Editor m�chten Sie benutzen? Bitte beachten Sie, dass wenn Sie einen anderen Editor als den XoopsEditor wählen m�chten, auch ein anderer Editor auf Ihrer Seite installiert sein muss.");

define("_MI_SSECTION_PV_TEXT", "Hinweis zur teilweisen Ansicht");
define("_MI_SSECTION_PV_TEXTDSC", "Hinweis für Artikel die nur teilweise eine Ansicht erm�glichen.");
define("_MI_SSECTION_PV_TEXT_DEF", "Zum lesen des gesamten Beitrages m�ssen Sie sich bitte registrieren.");

define("_MI_SSECTION_SEOMODNAME", "URL Rewriting Modulname");
define("_MI_SSECTION_SEOMODNAMEDSC", "Wenn URL Rewriting für das Modul aktiviert ist, ist die der Name der nach au�en angezeigt wird. Beispiel: http://yoursite.com/smartection/...");

define("_MI_SSECTION_ARTCOUNT", "Artikelz�hler anzeigen");
define("_MI_SSECTION_ARTCOUNTDSC", "W�hlen Sie 'JA' um den Artikelz�hler innerhalb jeder Kategorie in der Zusammenfassung bzw. Tabelle anzuzeigen. Bitte beachten Sie, Artikel aus Unterkategorien werden nicht mitgez�hlt bzw. zeigt der Artikelz�hler diese nicht an");
