...
define("_MI_SSECTION_ADMENU3", "Beiträge");
...
define("_MI_SSECTION_ALLOWSUBMIT", "Mitglieder dürfen Beiträge einsenden?");
define("_MI_SSECTION_ALLOWSUBMITDSC", "Erlaube Mitgliedern, einen Beitrag einzusenden?");
define("_MI_SSECTION_ANONPOST", "Dürfen Gäste auch Beiträge einsenden?");
define("_MI_SSECTION_ANONPOSTDSC", "Erlaube anonymen Usern, einen Beitrag einzusenden?");
define("_MI_SSECTION_AUTHOR_INFO", "Entwickler");
define("_MI_SSECTION_AUTHOR_WORD", "Worte des Autors");
define("_MI_SSECTION_AUTOAPP", "Automatische Freigabe von eingesendeten Beiträgen?");
define("_MI_SSECTION_AUTOAPPDSC", "Automatische Freigabe von eingesendeten Beiträgen ohne Admin-Intervention?");
define("_MI_SSECTION_BCRUMB","Zeige Modulname in der breadcrumb-Navigation?");
define("_MI_SSECTION_BCRUMBDSC","Wenn Sie Ja wählen, wird der breadcrumb anzeigen \"Smartsection > Kategoriename > Beitragsname\". <br>Andererseites wird nur \"Kategoriename > Artikelname\" angezeigt.");
...
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY", "Neuer Beitrag veröffentlicht");
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_CAP", "Benachrichtige mich, wenn ein neuer Beitrag in der aktuellen Kategorie veröffentlicht wurde.");   
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_DSC", "Informiere mich, wenn ein neuer Beitrag in der aktuellen Kategorie veröffentlicht wurde.");      
define("_MI_SSECTION_CATEGORY_ITEM_PUBLISHED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Beitrag in der Kategorie veröffentlicht"); 
define("_MI_SSECTION_CATEGORY_ITEM_SUBMITTED_NOTIFY", "Beitrag eingesendet");
define("_MI_SSECTION_CATEGORY_ITEM_SUBMITTED_NOTIFY_CAP", "Benachrichtige mich, wenn ein neuer Beitrag in der aktuellen Kategorie eingesendet wurde.");   
define("_MI_SSECTION_CATEGORY_ITEM_SUBMITTED_NOTIFY_DSC", "Informiere mich, wenn ein neuer Beitrag in der aktuellen Kategorie eingesendet wurde.");      
define("_MI_SSECTION_CATEGORY_ITEM_SUBMITTED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Beitrag in der Kategorie eingesendet"); 
...
define("_MI_SSECTION_CLONE", "Duplizieren von Beiträgen erlauben?");
define("_MI_SSECTION_CLONEDSC", "Wähle 'JA', um Usern mit entsprechender Berechtigung das Duplizieren von Beiträgen zu erlauben.");
define("_MI_SSECTION_COLLHEAD", "Anzeige der Zusammenfassung?");
define("_MI_SSECTION_COLLHEADDSC", "Wenn die Option auf 'Yes' setzen, wird die Kategoriezusammenfassung so wie auch die Beiträge angezeigt. Wenn Sie die Option auf 'No' setzen, wird die Zusammenfassung nicht angezeigt.");
define("_MI_SSECTION_COMMENTS", "Beitragskommentare per Level kontrollieren?");
define("_MI_SSECTION_COMMENTSDSC", "Wenn die Option auf 'JA' setzen, werden Kommentare nur für die Beiträge, die diese Checkbox markiert haben, angezeigt. <br /><br />Wähle 'Nein', um Kommentare auf globaler Ebene zu managen (sehen Sie auch unter dem Tag 'Komentar Eigenschaften'.");
...
define("_MI_SSECTION_DEVELOPER_LEAD", "Hauptentwickler (s)");
define("_MI_SSECTION_DEVELOPER_WEBSITE", "Webseite"); 
define("_MI_SSECTION_DISCOM", "Kommentarzähler anzeigen?");
define("_MI_SSECTION_DISCOMDSC", "Wähle 'Ja', um den Kommentarzähler in jedem individuellen Beitrag anzuzeigen");
define("_MI_SSECTION_DISDATECOL", "Zeige die 'Veröffentlicht am' Spalte?");
define("_MI_SSECTION_DISDATECOLDSC", "Wenn 'Zusammenfassung' ausgewählt wurde, wähle 'Ja' um das 'Veröffentlicht am' Datum in einer Beitragsspalte auf der Haupt- und Kategorieseite anzuzeigen.");
...
define("_MI_SSECTION_DISPLAY_CATEGORY_DSC", "Wähle 'Ja', um den Link zur Kategorie in jedem individuellen Beitrag anzuzeigen");
...
define("_MI_SSECTION_DISTYPE", "Beitrags-Anzeigetyp:");
define("_MI_SSECTION_DISTYPEDSC", "Wenn 'Zeige Zusammenfassung' ausgewählt ist, wird nur der Titel, das Datum und die Aufrufe von jedem Artikel in der ausgewählten Kategorie angezeigt. Wenn 'Vollansicht' ausgewählt ist, wird jeder Beitrag der ausgewählten Kategorie vollständig angezeigt.");
define("_MI_SSECTION_FILEUPLOADDIR", "Verzeichnis zum Hochladen von angehängten Dateien:");
define("_MI_SSECTION_FILEUPLOADDIRDSC", "Verzeichnis, in welches Anhänge zum Beitrag importiert werden können. Keine Schrägstriche verwenden.");
define("_MI_SSECTION_FOOTERPRINT","Fusszeile drucken");
define("_MI_SSECTION_FOOTERPRINTDSC","Fusszeile wird von jedem Beitrag gedruckt");
...
define("_MI_SSECTION_GLOBAL_ITEM_NOTIFY", "Globale Beiträge");
define("_MI_SSECTION_GLOBAL_ITEM_NOTIFY_DSC", "Benachrichtigungsoptionen, die für alle aktuellen Beitrag gelten.");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY", "Neuer Beitrag veröffentlicht");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_CAP", "Benachrichte mich, wenn ein neuer Beitrag veröffentlicht wurde.");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_DSC", "Mitteilung empfangen, wenn ein neuer Beitrag veröffentlicht wurde.");
define("_MI_SSECTION_GLOBAL_ITEM_PUBLISHED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Beitrag veröffentlicht");
define("_MI_SSECTION_GLOBAL_ITEM_SUBMITTED_NOTIFY", "Beitrag eingesendet");
define("_MI_SSECTION_GLOBAL_ITEM_SUBMITTED_NOTIFY_CAP", "Benachrichte mich, wenn ein neuer Beitrag eingesendet wurde und auf Freigabe wartet.");
define("_MI_SSECTION_GLOBAL_ITEM_SUBMITTED_NOTIFY_DSC", "Mitteilung empfangen, wenn ein neuer Beitrag eingesendet wurde auf Freigabe wartet.");
define("_MI_SSECTION_GLOBAL_ITEM_SUBMITTED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Neuer Beitrag eingesendet");
define("_MI_SSECTION_HEADERPRINT","Drucke Kopfzeile");
define("_MI_SSECTION_HEADERPRINTDSC","überschrift wird für jeden Beitrag mit gedruckt");
...
define("_MI_SSECTION_HITSCOLDSC", "Wenn 'Zusammenfassung' ausgewählt ist, wähle 'Ja', um die 'Aufrufe' Spalte in der Beitragstabelle auf der Haupt- und Kategorieseite anzuzeigen.");
...
define("_MI_SSECTION_ITEM_APPROVED_NOTIFY", "Genehmigte Beiträge");
define("_MI_SSECTION_ITEM_APPROVED_NOTIFY_CAP", "Benachrichte mich, wenn dieser Beitrag genehmigt ist.");   
define("_MI_SSECTION_ITEM_APPROVED_NOTIFY_DSC", "Mitteilung erhalten, wenn dieser Beitrag genehmigt ist.");      
define("_MI_SSECTION_ITEM_APPROVED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Beitrag genehmigt"); 
define("_MI_SSECTION_ITEM_NOTIFY", "Beitrag");
define("_MI_SSECTION_ITEM_NOTIFY_DSC", "Benachrichtigungsoptionen für aktuellen Beitrag.");
define("_MI_SSECTION_ITEM_REJECTED_NOTIFY", "Beitrag zurückgewiesen");
define("_MI_SSECTION_ITEM_REJECTED_NOTIFY_CAP", "Benachrichte mich, wenn dieser Beitrag zurückgewiesen wurde.");   
define("_MI_SSECTION_ITEM_REJECTED_NOTIFY_DSC", "Mitteilung erhalten, wenn dieser Beitrag zurückgewiesen wurde.");      
define("_MI_SSECTION_ITEM_REJECTED_NOTIFY_SBJ", "[{X_SITENAME}] {X_MODULE} Auto-Benachrichtigung: Beitrag zurückgewiesen"); 
define("_MI_SSECTION_ITEM_TYPE", "Beitrags-Typ:");
define("_MI_SSECTION_ITEM_TYPEDSC", "Wähle Art des Beitrags, die dieses Modul managen soll.");
define("_MI_SSECTION_ITEMFOOTER", "Beitragsfusszeile");
define("_MI_SSECTION_ITEMFOOTER_SEL", "Beitragsseitenende");
define("_MI_SSECTION_ITEMFOOTERDSC","Fusszeile wird für jeden Beitrag angezeigt");
define("_MI_SSECTION_ITEMSMENU", "Kategorien Menüblock");
//bd tree block hack
define("_MI_SSECTION_ITEMSTREE", "Tree Block");
//--/bd
define("_MI_SSECTION_ITEMSNEW", "Neue Beitragliste");
define("_MI_SSECTION_ITEMSPOT", "In die Spotlights!");
define("_MI_SSECTION_ITEMSRANDOM_ITEM", "Gelegentlicher Inhalt!");
define("_MI_SSECTION_LASTITEM", "Zeige letzten Beitrag in Spalte?");
define("_MI_SSECTION_LASTITEMDSC", "Wähle 'Ja', um den letzten Beitrag in jeder Kategorie auf der Haupt- und Kategorieseite anzuzeigen.");
define("_MI_SSECTION_LASTITEMS", "Zeige Liste der neuesten veröffentlichten Beiträge?");
define("_MI_SSECTION_LASTITEMSDSC", "Wähle 'Ja', um eine Liste  der Unterseiten auf der ersten Seite des Moduls anzuzeigen");
define("_MI_SSECTION_LASTITSIZE", "Letzte Größe des Beitrags:");
define("_MI_SSECTION_LASTITSIZEDSC", "Setze die maximale Größe des Titels in der letzten Beitragspalte.");
define("_MI_SSECTION_LINKPATH", "Erlaube Links zum aktuellen Pfad:");
define("_MI_SSECTION_LINKPATHDSC", "Diese Option erlaubt das Benutzer back-track durch Klicken auf ein Element auf den aktuellen Pfad, welcher oben auf der Seite angezeigt wird");
...
define("_MI_SSECTION_MD_DESC", "Section Verwaltungssystem für Ihre Impresscms-Seite");
define("_MI_SSECTION_MD_NAME", "SmartSection");
define("_MI_SSECTION_MODULE_BUG", "berichte einen Fehler für dieses Modul");
define("_MI_SSECTION_MODULE_DEMO", "Demoseite");
define("_MI_SSECTION_MODULE_DISCLAIMER", "Haftungsausschluss");
define("_MI_SSECTION_MODULE_FEATURE", "Schlage ein neues Funktion für dieses Modul vor");
...
define("_MI_SSECTION_ORDERBYDSC", "Wähle die Auftragsart des Beitrags aus.");
define("_MI_SSECTION_OTHER_ITEMS_TYPE_ALL", "Alle Beiträge");
define("_MI_SSECTION_OTHER_ITEMS_TYPE_NONE", "Keine");
define("_MI_SSECTION_OTHER_ITEMS_TYPE_PREVIOUS_NEXT", "Vorhergehender und folgender Beitrag");
define("_MI_SSECTION_OTHERITEMS", "Andere Artikel Anzeige-Typ");
define("_MI_SSECTION_OTHERITEMSDSC", "Wählen Sie aus, wie die anderen Beiträge der Kategorie auf der Beitragsseite dargestellt werden sollen.");
define("_MI_SSECTION_PERPAGE", "Maximale Anzahl der Beiträge pro Seite (Adminseite):");
define("_MI_SSECTION_PERPAGEDSC", "Maximale Anzahl der Beiträge pro Seite, die auf der Adminseite sofort angezeigt werden sollen.");
define("_MI_SSECTION_PERPAGEINDEX", "Maximale Anzahl der Beiträge pro Seite (Userseite):");
...
define("_MI_SSECTION_RECENTITEMS", "Neuer Beitrag (Details)");
...
define("_MI_SSECTION_SUB_SMNAME1", "Beitrag einsenden");
define("_MI_SSECTION_SUB_SMNAME2", "Populäre Beiträge");
...
define("_MI_SSECTION_TITLE_SIZEDSC", "Setze maximale Größe des Titels des einzelnen Beitrags.");
define("_MI_SSECTION_UPLOAD", "User Datei upload?");
define("_MI_SSECTION_UPLOADDSC", "Erlaube Usern mit den Beiträgen verlinkte Dateien zur Ihrer Webseite downzuloaden?");
...
define("_MI_SSECTION_WHOWHENDSC", "Wähle 'Ja', um den Autor und Datuminformationen in dem individuellen Beitrag anzuzeigen");
...
define("_MI_SSECTION_PV_TEXTDSC", "Hinweis für Beiträge die nur teilweise eine Ansicht ermöglichen.");
...
define("_MI_SSECTION_ARTCOUNT", "Beitragszähler anzeigen");
define("_MI_SSECTION_ARTCOUNTDSC", "Wählen Sie 'JA' um den Beitragszähler innerhalb jeder Kategorie in der Zusammenfassung bzw. Tabelle anzuzeigen. Bitte beachten Sie, Beiträge aus Unterkategorien werden nicht mitgezählt bzw. zeigt der Beitragzähler diese nicht an");
...
define('_MI_SSECTION_DATE_TO_DATE', 'Beiträge vom Datum bis Datum')
?>