...
define("_MB_SSECTION_CHARS", "L�nge des Titels");
define("_MB_SSECTION_COMMENTS", "Kommentar(s)");
define("_MB_SSECTION_DATE", "Ver�ffentlicht am");
...
define("_MB_SSECTION_POSTEDBY", "Ver�ffentlicht von");
define("_MB_SSECTION_READMORE", "Lesen Sie mehr...");
define("_MB_SSECTION_READS", "Lesen");
define("_MB_SSECTION_SELECT_ITEMS", "Wenn nein, w�hle den Artikel zum Anzeigen:");
...
define("_MB_SSECTION_WHO_WHEN", "Ver�ffentlicht von %s am %s");
//bd tree block hack
