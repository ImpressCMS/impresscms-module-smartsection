...
* Licence: GNU
*/
// tradução feita por beduino [aka joão luis barroca :)] deserto2004[@]hotmail.com
...
define("_MI_SSECTION_ALLOWSUBMIT", "[PERMISSIONS] Submissões do usuário:");
...
define("_MI_SSECTION_BCRUMB","[PRINT OPTIONS] Mostrar o nome do módulo no breadcrumb?");
...
define("_MI_SSECTION_CLONE", "[PERMISSIONS] Permitir duplicação de artigo?");
define("_MI_SSECTION_CLONEDSC", "Selecione 'Sim' para permitir que os usuários apropriados dupliquem um artigo.");
define("_MI_SSECTION_COLLHEAD", "[FORMAT OPTIONS] Mostrar a barra colapsável?");
...
define("_MI_SSECTION_COMMENTS", "[PERMISSIONS] Controlar comentários à nível de artigo?");
...
define("_MI_SSECTION_DISCOM", "[CONTENT OPTIONS] Mostrar contador de comentários?");
...
define("_MI_SSECTION_DISPLAY_CAT_SUMMARY_DSC", "Selecione'Sim' para ter o resumo de categoria exibida no módulo.");
define("_MI_SSECTION_DISPLAY_CATEGORY", "Exibir o nome de categoria ?");
define("_MI_SSECTION_DISPLAY_CATEGORY_DSC", "Marcar'Sim' irá exibir o link da categoria no artigo individual");
...
define("_MI_SSECTION_DISSBCATDSC", "[CONTENT OPTIONS] Mostar descrição das sub-categorias?");
...
define("_MI_SSECTION_DISTYPE", "[FORMAT OPTIONS] Forma de exibição do artigo:");
...
define("_MI_SSECTION_IMAGENAV", "[FORMAT OPTIONS] Usar a imagem Navegação na Página:");
...
define("_MI_SSECTION_INDEXMSG", "[CONTENT OPTIONS] Mensagem de boas-vindas do Índice");
...
define("_MI_SSECTION_LASTITEM", "[CONTENT OPTIONS] Mostrar coluna 'último item'?");
...
define("_MI_SSECTION_LASTITSIZE", "[FORMAT OPTIONS] Tamanho do último item :");
...
define("_MI_SSECTION_MAX_HEIGHT", "[PERMISSIONS] Altura máxima da imagem");
define("_MI_SSECTION_MAX_HEIGHTDSC", "Altura máxima do arquivo de imagem que pode ser carregado");
define("_MI_SSECTION_MAX_SIZE", "[PERMISSIONS] Tamanho máximo de arquivo");
define("_MI_SSECTION_MAX_SIZEDSC", "Tamanho máximo [em bytes] de um arquivo para ser carregado.");
define("_MI_SSECTION_MAX_WIDTH", "[PERMISSIONS] Largura máxima da imagem a ser carregada");
...
define("_MI_SSECTION_ORDERBY", "[FORMAT OPTIONS] Ordem de classificação");
...
define("_MI_SSECTION_OTHERITEMS", "[FORMAT OPTIONS] Tipo de exibição de outros artigos");
...
define("_MI_SSECTION_SUBMITMSG", "[CONTENT OPTIONS] Apresentar página de introdução:");
...
define("_MI_SSECTION_UPLOAD", "[PERMISSIONS] Usuário pode fazer upload?");
...
define("_MI_SSECTION_WELCOME", "[CONTENT OPTIONS] Mostrar o título e a mensagem de boas-vindas:");
...
define("_MI_SSECTION_WHOWHEN", "[CONTENT OPTIONS] Mostrar o anúncio e a data?");
